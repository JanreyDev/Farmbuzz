...
class CreatePostModal extends StatefulWidget {
  ...
  final Future<void> Function(String text, List<String> imagePaths)?
  onPostCreated;

  /// Static utility to show the create post modal.
  static void show(
    BuildContext context, {
    Future<void> Function(String text, List<String> imagePaths)? onPostCreated,
  }) {
...
class _CreatePostModalState extends State<CreatePostModal> {
  ...
  void _updatePostState() {
    setState(() {
      _canPost =
          _postController.text.trim().isNotEmpty || _selectedImages.isNotEmpty;
    });
  }
